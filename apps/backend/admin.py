...
# Add current directory to path to find app.py and its models
...
def main():
    ...
    reset_parser.add_argument('--email', help='Admin email', default='admin@geneforge.com')
    reset_parser.add_argument('--password', help='Admin password', default='admin123')
