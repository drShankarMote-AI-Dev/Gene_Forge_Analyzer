            ...
            <DialogContent className="sm:max-w-[425px] glass-card border-primary/20 shadow-2xl overflow-hidden">
                ...
                <DialogHeader className="space-y-4">
                    ...
                    <div>
                        <DialogTitle className="text-2xl font-black text-center tracking-tight uppercase italic">
                            {mode === 'login' ? (
                                <>Secure <span className="text-primary not-italic">Access</span></>
                            ) : (
                                <>Cluster <span className="text-primary not-italic">Registry</span></>
                            )}
                        </DialogTitle>
                ...
                <div className="py-2">
                    ...
                    <div className="flex flex-col items-center w-full gap-4">
                        ...
                        {/* Warning removed as config is verified */}
                    </div>
