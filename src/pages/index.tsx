...
import { countBases, reverseComplement } from '@/utils/dnaUtils';
                    ...
                    <div className="space-y-8">
                        ...
                        {!sequence && (
                            <div className="py-20 flex flex-col items-center justify-center glass rounded-[4rem] border-dashed border-primary/20 animate-pulse">
                                <div className="p-8 rounded-[3rem] bg-primary/5 mb-8">
                                    <Dna className="h-20 w-20 text-primary opacity-20" />
                                </div>
                ...
                <div className="relative z-10 flex flex-col items-center gap-4">
                    <div className="flex gap-8 mb-4">
                        {['Architecture', 'Security', 'Compliance', 'Privacy'].map(item => (
                            <span key={item} className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/40 hover:text-primary transition-colors cursor-pointer">{item}</span>
                        ))}
                    </div>
